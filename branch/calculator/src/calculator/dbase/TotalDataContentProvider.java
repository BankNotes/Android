...
public class TotalDataContentProvider extends ContentProvider {
	private DbHelper dbHelper;
	private static HashMap<String, String> TOTALS_PROJECTION_MAP;
	private static final String TABLE_NAME = "totals";
	private static final String AUTHORITY = "calculator.ru.totaldatacontentprovider";
	...
	public static final Uri SUMPERCENTPAYS_FIELD_CONTENT_URI = Uri
			.parse("content://" + AUTHORITY + "/" + TABLE_NAME.toLowerCase()
					+ "/sumpercentpays");
	public static final Uri SUMPAYFEE_FIELD_CONTENT_URI = Uri.parse("content://"
	...
	public String getType(Uri url) {
		switch (URL_MATCHER.match(url)) {
		case TOTAL:
			return "vnd.android.cursor.dir/vnd.calculator.ru.totals";
		case TOTALS_ID:
			return "vnd.android.cursor.item/vnd.calculator.ru.totals";
		case TOTALS_ID_CALC:
			return "vnd.android.cursor.item/vnd.calculator.ru.totals";
		case TOTALS_SUMPAYS:
			return "vnd.android.cursor.item/vnd.calculator.ru.totals";
	...
	public Uri insert(Uri url, ContentValues initialValues) {
		...
		if (URL_MATCHER.match(url) != TOTAL) {
			throw new IllegalArgumentException("Unknown URL " + url);
		}
	...
	static {
		...
		URL_MATCHER.addURI(AUTHORITY, TABLE_NAME.toLowerCase() + "/sumpays"
				+ "/*", TOTALS_SUMPAYS);
		URL_MATCHER.addURI(AUTHORITY, TABLE_NAME.toLowerCase() + "/sumpercentpays"
				+ "/*", TOTALS_SUMPERCENTPAYS);
